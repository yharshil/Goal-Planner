...
import com.harshilyadav.bucketdrops.adapters.AdapterDrops;
import com.harshilyadav.bucketdrops.adapters.AddListener;
import com.harshilyadav.bucketdrops.adapters.CompleteListener;
import com.harshilyadav.bucketdrops.adapters.Dividers;
import com.harshilyadav.bucketdrops.adapters.Filter;
import com.harshilyadav.bucketdrops.adapters.Marklistener;
import com.harshilyadav.bucketdrops.adapters.ResetListener;
import com.harshilyadav.bucketdrops.adapters.SimpleTouchCallback;
import com.harshilyadav.bucketdrops.beans.Drop;
import com.harshilyadav.bucketdrops.extras.utils;
import com.harshilyadav.bucketdrops.services.NotificationService;
import com.harshilyadav.bucketdrops.widgets.BucketRecyclerView;
...
public class ActivityMain extends AppCompatActivity {
    ...
    private void showDialogMark(int position) {
        ...
        dialog.show(getFragmentManager(), "Mark");
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecycler.addItemDecoration(new Dividers(this, LinearLayoutManager.VERTICAL));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_add:
                showDialogAdd();
                break;
            case R.id.action_sortnone:
                filterOption = Filter.NONE;
                break;
            case R.id.action_sortascendingdate:
                filterOption = Filter.LEAST_TIME_LEFT;
                break;
            case R.id.action_sortdescendingdate:
                filterOption = Filter.MOST_TIME_LEFT;
                break;
            case R.id.action_showcomplete:
                filterOption = Filter.COMPLETE;
                break;
            case R.id.action_showincomplete:
